from ..Spaces import (mint_block_rewards_space, mint_pokt_mechanism_space, assign_servicer_salary_space,
                      validator_block_reward_space, burn_pokt_space, burn_pokt_mechanism_space, distribute_fees_space,
                      decrease_relay_fees_space, modify_validator_pokt_space, modify_dao_pokt_space)
...
Based upon the numerous parameters, the total reward for each group is determined. For a more detailed version of the policy, one can look here: https://docs.google.com/spreadsheets/d/1QYe6NzuiyimsXs5cT1BSM-UT1DtX_K38cOZsEFJOtdA/edit#gid=242780369""",
                        ...
                        "parameters_used": ["relays_to_tokens_multiplier", "block_proposer_allocation",
...
distribute_fees_policy = {"name": "Distribute Fees Policy",
...
For a more detailed version of the policy, one can look here: https://docs.google.com/spreadsheets/d/1QYe6NzuiyimsXs5cT1BSM-UT1DtX_K38cOZsEFJOtdA/edit#gid=242780369""",
                        ...
                        "codomain": [decrease_relay_fees_space, modify_validator_pokt_space, modify_dao_pokt_space],
