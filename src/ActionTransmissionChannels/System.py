...
system_transmission_channels = []

system_transmission_channels.append(
    {
        "origin": "Mint Block Rewards",
...
system_transmission_channels.append(
    {
        "origin": "Block Reward Policy Aggregate",
...
system_transmission_channels.append(
    {
        "origin": "Assign Servicer Salary Policy",
...
system_transmission_channels.append(
    {
        "origin": "DAO Block Reward Policy",
...
system_transmission_channels.append(
    {
        "origin": "Validator Block Reward Policy",
...
system_transmission_channels.append(
    {
        "origin": "Distribute Fees Policy",
        "target": "Decrease Relay Fees",
        "space": decrease_relay_fees_space,
        "optional": False,
    }
)
