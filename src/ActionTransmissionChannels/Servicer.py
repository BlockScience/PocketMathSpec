from ..Spaces import (servicer_stake_space, modify_servicer_pokt_space, servicer_param_update_space,
                      ...
                      burn_pokt_mechanism_space, jail_node_space, unjail_node_space, servicer_forced_unstake_space,
...
servicer_transmission_channels.append({"origin": "Jail Node",
...
servicer_transmission_channels.append({"origin":"Servicer Forced Unstake",
                                        "target": "Servicer Forced Unstake Policy",
                                        "space": servicer_forced_unstake_space,
                                        "optional": False})

servicer_transmission_channels.append({"origin": "Servicer Forced Unstake Policy",
                                        "target": "Modify Servicer Stake",
                                        "space": modify_servicer_pokt_space,
                                        "optional": False})
