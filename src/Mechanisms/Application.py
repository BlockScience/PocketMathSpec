...
modify_application_pokt_holdings = {
    "name": "Modify Application POKT Holdings",
...
update_application_params = {
    "name": "Update Application Params",
...
update_application_stake_status = {
    "name": "Update Application Stake Status",
...
update_application_delegate = {
    "name": "Update Application Delegate",
    "description": "The mechanism which updates delegate gateway that can act on its behalf.",
    "constraints": [],
    "logic": "Set the delegate mechanism for the application at DOMAIN[0].application_public_key to DOMAIN[0].gateway_public_key",
